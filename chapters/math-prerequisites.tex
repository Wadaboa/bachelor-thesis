...
Un'immagine digitale \textit{I} con risoluzione $m\times n$ ($width \times height$) \`e una matrice di valori interi di dimensione $n\times m$, che pu\`o essere matematicamente interpretata come una funzione semplice (n\`e iniettiva, n\`e suriettiva) 
\begin{equation}
