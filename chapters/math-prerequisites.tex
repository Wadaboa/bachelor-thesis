...
\begin{figure}[H]
	...
	\resizebox{\textwidth}{!}{
		...
		\subfloat[Mask] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/reconstruction-mask.png}}
			}
		}
		\subfloat[Marker] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/reconstruction-marker.png}}
			}
		}
		\subfloat[Output] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/reconstruction-output.png}}
			}
		}
	}
...
\begin{figure}[H]
	...
	\resizebox{\textwidth}{!}{
		...
		\subfloat[Input] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/opening-reconstruction-input.png}}
			}
		}
		\subfloat[Output \textit{apertura}] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/opening-output.png}}
			}
		}
		\subfloat[Output \textit{apertura} con \textit{ricostruzione}] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/opening-reconstruction-output.png}}
			}
		}
	}
...
\par Altri operatori morfologici sono quello \textit{hit-or-miss}, che consente di estrarre pixel i cui vicini hanno una specifica configurazione (\textit{pattern}), in base allo SE utilizzato; oppure quello del \textit{gradiente}, che consiste nella differenza tra dilatazione e erosione di un'immagine, e restituisce, ad esempio, i contorni di oggetti (vedi figura \ref{fig:morph-gradient}).
\begin{figure}[H]
	\centering
	\resizebox{.7\textwidth}{!}{
		\centering
		\subfloat[Input] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/gradient-input.png}}
			}
		}
		\subfloat[Output] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/gradient-output.png}}
			}
		}
	}
