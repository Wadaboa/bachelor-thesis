...
Consideriamo l'immagine \ref{fig:image-bin-proposed-approach-input} come esempio per l'analisi delle operazioni descritte in seguito.
\begin{figure}[h]
	\centering
...
\begin{equation}
	...
	g_{Q_{SE}}^{w}(I) = I - \tilde{\phi}_{R}(\tilde{\gamma}_{R}(I)),
\end{equation}
