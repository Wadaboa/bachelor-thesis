...
\begin{figure}[H]
	...
	\resizebox{\textwidth}{!}{
		...
		\subfloat[Scene] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/lena-template-matching-input.png}}
			}
		}
		\subfloat[Template] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/lena-lips-template.png}}
			}
		}
		\subfloat[Match] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/lena-template-matching-output.png}}
			}
		}
	}
...
\begin{figure}[H]
	...
	\resizebox{\textwidth}{!}{
		...
		\subfloat[Input] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/building.png}}
			}
		}
		\subfloat[\textit{SURF}] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/building-surf-keypoints.png}}
			}
		}
		\subfloat[\textit{AKAZE}] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/building-akaze-keypoints.png}}
			}
		}
	}
...
\begin{figure}[h]
	...
	\resizebox{.9\textwidth}{!}{
		...
		\subfloat[\textit{Sobel} direzione $x$] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/sobel-x.png}}
			}
		}
		\subfloat[\textit{Sobel} direzione $y$] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/sobel-y.png}}
			}
		}
	}
...
\begin{figure}[h]
	...
	\resizebox{.9\textwidth}{!}{
		...
		\subfloat[Input] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/canny-hed-input.png}}
			}
		}
		\subfloat[Output] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/hed-output.png}}
			}
		}
		\subfloat[Output con \textit{dilatazione}] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/hed-output-dilated.png}}
			}
		}
	}
