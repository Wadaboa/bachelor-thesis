...
\end{figure}
\footnotetext{Fonte: \emph{A Comparative Analysis of SIFT, SURF, KAZE, AKAZE, ORB, and BRISK} \cite{bib:feature-matching-comparison}}
...
\begin{figure}[h]
	...
	\resizebox{\textwidth}{!}{
		...
		\subfloat[\textit{Sobel} direzione $x$] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.5\linewidth]{img/sobel-x.png}}
			}
		}
		\subfloat[\textit{Sobel} direzione $y$] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.5\linewidth]{img/sobel-y.png}}
			}
		}
	}
