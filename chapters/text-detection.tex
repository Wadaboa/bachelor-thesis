...
\begin{figure}[h]
	...
	\resizebox{\textwidth}{!}{
		...
		\subfloat[Output] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/mser-regions.png}}
			}
		}
		\subfloat[Output filtrato] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.8\linewidth]{img/mser-regions-filtered.png}}
			}
		}
	}
...
\begin{figure}[h]
	...
	\resizebox{.9\textwidth}{!}{
		...
		\subfloat[Input] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=\linewidth]{img/mser-east-input.png}}
			}
		}
		\subfloat[Output] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=\linewidth]{img/east-output.png}}
			}
		}
	}
...
\begin{figure}[h]
	...
	\resizebox{\textwidth}{!}{
		...
		\subfloat[Nome] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.5\linewidth]{img/car-f-name-static.png}}
			}
		}
		\subfloat[Cognome] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.5\linewidth]{img/car-f-surname-static.png}}
			}
		}
		\subfloat[Data di nascita] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.5\linewidth]{img/car-f-birthdate-static.png}}
			}
		}
	}
...
\begin{figure}[H]
	...
	\resizebox{\textwidth}{!}{
		...
		\subfloat[Nome] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.5\linewidth]{img/car-f-name-dynamic.png}}
			}
		}
		\subfloat[Cognome] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.5\linewidth]{img/car-f-surname-dynamic.png}}
			}
		}
		\subfloat[Data di nascita] {%
			\scalebox{0.5}[0.5] {
				\frame{\includegraphics[width=.5\linewidth]{img/car-f-birthdate-dynamic.png}}
			}
		}
	}
